...
```{r gghighlight, fig.margin = TRUE, fig.cap="An example of a new geom from gghighlight"}
#from readme
library(gghighlight)
library(ggplot2)
set.seed(2)
...
```{r ggforce, fig.margin = TRUE, fig.cap="An example of a new geom from ggforce"}
library(ggforce)
