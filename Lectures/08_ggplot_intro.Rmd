...
2. Create a line plot of year on the x and anomoly on the y. Include month as a group. Try coloring *also* by anomoly. First use the default palatte, and then try a blue-white-red.
