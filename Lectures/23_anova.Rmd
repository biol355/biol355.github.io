...
<div class="fragment">If groups are a meaningful explanatory variable, what does that imply about variability in the data?</div>
...
##  Eelgrass Genotypes
```{r, eval=FALSE, echo=TRUE}
eelgrass <- read.csv("./data/anova/EelgrassGenotypes.csv")
