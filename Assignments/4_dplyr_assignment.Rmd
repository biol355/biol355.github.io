...
&nbsp; &nbsp; 4b. Calculate the summed birthweight count for each birthweight group and latitude group - but also calculate the mean latitude in that group.  
