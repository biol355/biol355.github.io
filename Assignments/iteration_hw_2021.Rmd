...
[Here](./data/counties.zip) is a set of RDS files that contain sf objects of state county boundaries. We are going to work with these using iteration and functions to 
