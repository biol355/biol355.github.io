...
### Week  8. Data "Mashups" and Geospatial Data
```{r next_date, echo=FALSE}
```
...
__Lectures:__ [Joins](./Lectures/15_joins.pptx), [Rasters](./Lectures/16_raster_gis_intro.html)    
__Files:__   [Hemlock](../Data/hemlock.xlsx), [hemlock_densities](../Data/hemlock_densities.xlsx), [Harvard elevation data](./Lectures/data/HARV_dsmCrop.tif)   
