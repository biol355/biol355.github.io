...
__Lectures:__  [Intro to GIS](./Lectures/15_gis_intro.html), [Rasters](https://datacarpentry.org/r-raster-vector-geospatial/01-raster-structure/index.html) and [plotting rasters](https://datacarpentry.org/r-raster-vector-geospatial/02-raster-plot/index.html), [Joins](./Lectures/15_joins.pptx), [Vector Data](https://datacarpentry.org/r-raster-vector-geospatial/)  
...
__Files:__  [geospatial data for lab](https://ndownloader.figshare.com/articles/2009586/versions/10), [Hemlock](../Data/hemlock.xlsx), [hemlock_densities](../Data/hemlock_densities.xlsx),  [Arctic Boreal Forest Vegetation](./Lectures/data/boreal.csv), [Heart Disease in America](./Labs/data/hd_all.xlsx), [data for lab on joins](./Labs/data/joinmap_data.zip), [US County Borders in 2013](./Lectures/data/cb_2013_us_county_500k.zip), [March 18, 2018 SST Anomalies ](./Lectures/data/sst_anom.bin.20180318.tif)   
...
__MIDTERM__: Due March 20th [make a cheatsheet](./midterm/midterm.html)      
