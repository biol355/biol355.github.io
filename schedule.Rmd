...
__Lectures:__  [Intro to GIS](./Lectures/15_git_intro.html), [Rasters](./Lectures/16_raster_gis_intro.html), [GIS in R](./Lectures/17_gis_in_r.html),  [Joins](./Lectures/15_joins.pptx), [Interactive Maps](./Lectures/18_interactive_maps.Rmd)   
__Labs:__ [Lessons 1,2, 6-8 from Data Carpentry Geospatial Lab](https://datacarpentry.org/r-raster-vector-geospatial/), [joins and maps](./Labs/join_maps_lab.html)  
...
__Optional Reading:__ [Making maps in R](https://geocompr.robinlovelace.net/adv-map.html) and other chapters in Geocomputation in R. [Spatial Data Science](https://keen-swartz-3146c4.netlify.com/)   
...
```
`r datestring`
__Readings:__ [Mastering Shiny](https://mastering-shiny.org/) Ch. 1-4
