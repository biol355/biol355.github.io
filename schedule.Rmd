...
__Homework:__ [Regular Expressions](./Labs/lab6_regex_practice.html)  
...
__Lectures:__ [Joins](./Lectures/15_joins.pptx), [Rasters](./Lectures/16_raster_gis_intro.html), [Intro to GIS and R](./Lectures/17_gis_in_r.html)  
...
__Files:__   [Hemlock](../Data/hemlock.xlsx), [hemlock_densities](../Data/hemlock_densities.xlsx), [Harvard elevation data](./Lectures/data/HARV_dsmCrop.tif), [Arctic Boreal Forest Vegetation](./Lectures/data/boreal.csv), [Heart Disease in America](./Lectures/data/hd_all.xlsx)   
__Etherpad:__ https://etherpad.wikimedia.org/p/355-gis  
__Before Class:__ Install `rgdal` (you'll need to install gdal first - see below), `sf`, `sp`, `raster`, and `rgeos`. 
