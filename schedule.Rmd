...
__Lecture:__ [Tidy Data](./Lectures/13_data_tidy.html), [tidy faded examples]()  
...
__Biological Examples:__ [Axoltl limb regeneration](./Lectures/data/ALM assay statistics.xlsx). [Mammal taxonomic records](./Lectures/data/mammals.R).  [Weather data](./Data/weather_messy.csv).  
__Etherpad:__ https://etherpad.wikimedia.org/p/355-tidy  
__Homework__: [Weather Data Cleaning](./Assignments/tidyr_over_break.html)  
