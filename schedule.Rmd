...
__Homework:__ [Functions and t-tests](./assignments/7_functions_tidyr.html), [Marmoset data](./assignments/monkey_weights.xlsx)  
  
### Week 12. Analysis of Variance and the Linear Model
```{r next_date, echo=FALSE}
```
 `r datestring`  
__Lectures:__ [Analysis of Variance](./Lectures/23_anova.html)  
...
__Biological Examples:__  Jet-lag recovery and circadian rhythms. Seal life history variation  
