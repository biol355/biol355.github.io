...
All assignments should be turned in [on canvas](https://umassboston.instructure.com/courses/41128/assignments). For R assignments, please make a full project for each assignment. Include all code and data needed to compile the relevant quarto document as well as a fully rendered document. Zip up the folder for the assignment (generally, right click on the folder and select 'compress' or 'make archive'), and submit the zip file.
  
W&G = [Wickham & Grolemund](http://r4ds.hadley.nz), DC = Data Carpentry Lesson, U/P for linked pdfs = biol355
    
```{r dates, echo=FALSE, message=FALSE, warning=FALSE}
library(lubridate)
current_date <- parse_date_time("2026-01-26", orders="ymd")-days(7)
```
...
```
`r datestring`  
__Lecture:__ [Welcome!](./Lectures/01_intro.pptx),  [Data Collection and Metadata](./Lectures/02_data_creation.html)  
__Readings:__ [W&G Introduction Chapter 1](http://r4ds.hadley.nz/intro.html), [Browman and Woo 2017](./Readings/Browman_and_Woo_Spreadsheets.pdf)  
...
__Etherpad:__ https://etherpad.wikimedia.org/p/355-spreadsheets-2026_spring   

<!--
### Week  2. Introduction to R and RMarkdown  

`r datestring`  
__Readings:__ W&G On [Workflow Basics](https://r4ds.hadley.nz/workflow-basics.html) and [Projects](https://r4ds.hadley.nz/workflow-projects.html)    
...
__Etherpad:__  https://etherpad.wikimedia.org/p/biol355-r-intro-2026_spring    
...
```
`r datestring`  
__Readings:__ W&G On [Workflow Basics](https://r4ds.hadley.nz/workflow-basics.html) and [Scripts and Projects](https://r4ds.hadley.nz/workflow-scripts.html), [Tibbles & Data Frames](https://r4ds.had.co.nz/tibbles.html), [Data Import](http://r4ds.hadley.nz/data-import.html), [Spreadsheets](https://r4ds.hadley.nz/spreadsheets.html)  
__Lectures:__  DC Ecology [Intro to R](https://datacarpentry.github.io/R-ecology-lesson/introduction-r-rstudio.html) and [exploring and understanding data](https://datacarpentry.github.io/R-ecology-lesson/how-r-thinks-about-data.html)   
...
__Lab:__ [Intro to Quarto](https://r4ds.hadley.nz/quarto.html), [R Markdown and Data Subsetting](./Labs/Lab_Rmarkdown_Subsetting.html)  
<!-- __Exercises:__ [Warmup Excercises for Friday](./Labs/lab_2_warmup.html)  -->
__Cheat Sheets:__  [Data Import](https://github.com/rstudio/cheatsheets/raw/master/data-import.pdf)  
__Files:__ [Excel](./Data/my_data.xlsx), [CSV](./Data/my_data.csv)     
__Homework:__ [Intro to R](./Assignments/1_intro_r.html)   
__Etherpad:__  https://etherpad.wikimedia.org/p/biol355-r-intro-2026_spring    
...
```
`r datestring`  
__Readings:__ W&G on [Data Visualization](https://r4ds.hadley.nz/data-visualize.html),  [Unwin 2008](./Readings/Unwin_2008_dataviz.pdf), [Exploring Data Visually](https://r4ds.hadley.nz/eda).   
__Lectures:__ [Principles of Data Visualization](./Lectures/07_data_viz_principles.pdf), [Intro to ggplot2](https://biol607.github.io/lab/04_ggplot_palmer_intro.html)  
__Lab:__ [ggplot2 and climate change](./Labs/ggplot_climate_lab.html)<!-- [ggplot2 and climate change](./Lectures/08_ggplot_intro.html) -->  
...
__Biological Examples:__  [Plum Island LTER Plankton Distribution](./Lectures/data/EST-PR-PlanktonChemTax.xls). [HAD CRUT Global temperature anomaly over the past century](./Lectures/data/hadcrut_temp_anomoly_1850_2021.csv)  
...
__Etherpad:__ https://etherpad.wikimedia.org/p/355-dataviz-2026_spring  
...
`r datestring`  
__Readings:__ W&G on [Data Transformation](http://r4ds.hadley.nz/transform.html) and [Pipes](https://r4ds.hadley.nz/workflow-pipes.html), DC Ecology Lesson on [Data Aggregation](http://www.datacarpentry.org/R-ecology-lesson/03-dplyr.html)  
__Lecture:__ [Organizing Data to Tell a Story](./Lectures/09_summarizing_data.html)   
__Lab:__ [Working with Dplyr and Data](https://datacarpentry.github.io/R-ecology-lesson/working-with-data.html), [Dplyr Faded Example Practice](./Lectures/dplyr_faded_examples.html)<!--, [Data for Exploratory Data Analysis of Mortality and Natality with dplyr and ggplot2](./Labs/freeform_dplyr.zip)-->   
...
__Etherpad:__ https://etherpad.wikimedia.org/p/355-dplyr-2026_spring  
...
`r datestring`  
__Readings:__ W&G on [Strings](http://r4ds.hadley.nz/strings.html), [Dates and Times](http://r4ds.hadley.nz/dates-and-times.html), and [Factors](http://r4ds.hadley.nz/factors.html)  
...
__Cheat Sheets:__ [Work with Strings Cheat Sheet](https://raw.githubusercontent.com/rstudio/cheatsheets/main/strings.pdf)  
...
__Etherpad:__ https://etherpad.wikimedia.org/p/355-strings-2026_spring  
...
```
`r datestring`  
__Readings:__ W&G Chapters on [Tidy Data](http://r4ds.hadley.nz/tidy-data.html)  
__Lecture:__ [Reshaping Data to be Tidy](https://datacarpentry.github.io/R-ecology-lesson/working-with-data.html#reshaping-data-with-tidyr), [Tidy Data](./Lectures/13_data_tidy.html)    
...
__Readings:__   [Intro to Geocomputation in R](https://geocompr.robinlovelace.net/intro.html), [Geographic Data in R](https://geocompr.robinlovelace.net/spatial-class.html), W&G Chapter on [Relational Data](http://r4ds.hadley.nz/relational-data.html)    
__Lectures:__  [Intro to GIS](./Lectures/15_gis_intro.html), [Rasters](https://cobalt-casco.github.io/r-raster-vector-geospatial/01-raster-structure.html) and [plotting rasters](https://cobalt-casco.github.io/r-raster-vector-geospatial/02-raster-plot.html),  [Vector Data](https://cobalt-casco.github.io/r-raster-vector-geospatial/06-vector-open-shapefile-in-r.html), [Plotting Vector Data](https://cobalt-casco.github.io/r-raster-vector-geospatial/07-vector-shapefile-attributes-in-r.html), [Plotting Multiple Vectors](https://cobalt-casco.github.io/r-raster-vector-geospatial/08-vector-plot-shapefiles-custom-legend.html), [Joins](./Lectures/15_joins.pptx)  
<!-- __Labs:__ [coronavirus spatial mapping](./Labs/coronavirus_spatial.html) [joins and maps](./Labs/join_maps_lab.html)  -->
...
__Biological Examples:__ Seagrass in Casco Bay, Hemlock wooly adelgid distribution. CDC records of heart disease across counties of the US. Change in coastal sea surface temperature since 1850. Global TB mortality distribution.  
...
__Files:__  [geospatial data for lab](https://figshare.com/ndownloader/files/43910115), [Hemlock](../Data/hemlock.xlsx), [hemlock_densities](../Data/hemlock_densities.xlsx),  [Arctic Boreal Forest Vegetation](./Lectures/data/boreal.csv), [Heart Disease in America](./Labs/data/hd_all.xlsx), [data for lab on joins](./Labs/data/joinmap_data.zip), [US County Borders in 2013](./Lectures/data/cb_2013_us_county_500k.zip), [March 18, 2018 SST Anomalies ](./Lectures/data/sst_anom.bin.20180318.tif)   
__Etherpad:__ https://etherpad.wikimedia.org/p/355-gis-2026_spring  
__Homework:__ [Map making!](./Assignments/gis_in_r.html)  
__Before Class:__ Install `rgdal` (you'll need to install gdal first - see below), `sf`, `terra`, `sp`, `raster`, `leaflet`, `maptools`, `mapdata`, and `rgeos`. See [here](https://cobalt-casco.github.io/geospatial-workshop/#setup) for instructions.
__MIDTERM__: Due March 27th [make a cheatsheet](./midterm/midterm.html)      
...
`r datestring`  
__Readings:__ W&G Chapters on [Functions](http://r4ds.hadley.nz/functions.html)   
__Lectures:__ [Intro to Functions](https://biol607.github.io/lectures/functions.html#/section), [Functions and Flexibility](./Lectures/19_functions_practice.html)  
...
__Etherpad:__ https://etherpad.wikimedia.org/p/355-functions-2026_spring  

### Week  10 Iteration 
```{r next_date, echo=FALSE}
```
 `r datestring`   
__Readings:__ W&G Chapters on  [Iteration](http://r4ds.hadley.nz/iteration.html)  
__Optional Reading:__ Advanced R on [functionals] (https://adv-r.hadley.nz/functionals.html)  
__Lectures:__  [Iteration with purrr](./Lectures/20_iteration.html)  
__Lab:__ [Importing Hospital Records](https://www.gerkelab.com/blog/2018/09/import-directory-csv-purrr-readr/), [Bioinformatics and List Columns](https://htmlpreview.github.io/?https://github.com/swuyts/purrr_tutorial/blob/master/purrr.html) <!-- [Many Models](https://r4ds.hadley.nz/many-models.html)-->  
...
__Etherpad:__ https://etherpad.wikimedia.org/p/355-iteration-2026_spring 
...
__Lecture & Lab:__ [Building Shiny Apps for Seagrass Maps](https://cobalt-casco.github.io/r-shiny-geospatial/)  
__Optional Reading:__ [Building Shiny Apps from Dean Attali](https://docs.google.com/presentation/d/1dXhqqsD7dPOOdcC5Y7RW--dEU7UfU52qlb0YD3kKeLw/edit#slide=id.gd565d6fc7_0_182), [Exercises for Building Shiny Appsfrom Dean Attal](https://deanattali.com/blog/building-shiny-apps-tutorial/)  
__Data:__  [merged seagrass data](https://cobalt-casco.github.io/r-shiny-geospatial/data/joined_seagrass_cover.Rds), [geospatial data from a few weeks ago](https://figshare.com/ndownloader/files/43910115)
<!-- __Data:__[download](Lectures/data/shiny/checkbook_explorerfy21.csv) which is originally from [here](https://data.boston.gov/dataset/checkbook-explorer/resource/32897eeb-d9ca-494f-93b1-991c50bcd6a6) -->  
__Additional Resource:__ https://shiny.rstudio.com/tutorial/  
__Homework:__ [Shiny homework with coronavirus](./Labs/shiny_lab.html)  
__Etherpad:__ https://etherpad.wikimedia.org/p/355-shiny-2026_spring  
...
__Lectures:__ [Introduction to Modeling](./Lectures/modeling_intro.html), [Single Predictor Models](./Lectures/one_predictor_models.html)  
__Objective(s):__ Understand the workflow of generating inference from data, Describe the basics of probability and p-values, Model linear relationships in data, Compare groups of data using T-tests and ANOVa  
__Biological Examples:__ Batesian mimicry, Penguin morphometrics, The effects of testosterone on bird behavior.  
__Lab:__ [the basics of linear models in R](./Labs/lm_anova_lab.html).   
__Etherpad:__ https://etherpad.wikimedia.org/p/355-modeling-2026_spring  

### Week  13. Modeling with Many Predictors 
```{r next_date, echo=FALSE}
```
`r datestring`  
__Readings:__  W&G on [Model Basics](http://r4ds.hadley.nz/model-basics.html)  
__Lectures:__ [Multiple Predictors and Model Comparison](./Lectures/many_predictors.html), [The General Linear Model](./Lectures/advanced_models.html)  
...
__Lab:__ [general linear models](Labs/lm_glm_lab.html)  
__Data for Lab:__ from last week  
__Etherpad:__ https://etherpad.wikimedia.org/p/355-many_predictors-2026_spring  
...
```
`r datestring`  
Final Presentations on the morning of May 12th!
(Papers due end of day May 17th)
...
__Etherpad:__ https://etherpad.wikimedia.org/p/355-ttest-2026_spring  
...
__Etherpad:__ https://etherpad.wikimedia.org/p/355-anova-2026_spring   
...
__Etherpad:__ https://etherpad.wikimedia.org/p/355-mlr-2026_spring

### Week  14 Multiple Predictors Part 2  
`datestring`  
__Readings:__  W&G on [Model Building](http://r4ds.hadley.nz/model-building.html)  
...
__Etherpad:__ https://etherpad.wikimedia.org/p/355-aic-2026_spring
