...
G&W = [Grolemund and Wickham](http://r4ds.had.co.nz), DC = Data Carpentry Lesson, U/P for linked pdfs = biol355
...
```
`r datestring`  
__Readings:__ [G&W Introduction Chapter 1](http://r4ds.had.co.nz/introduction.html)  
...
__Readings:__ G&W on [Data Transformation](http://r4ds.had.co.nz/transform.html), [Exploratory Data Analysis](http://r4ds.had.co.nz/exploratory-data-analysis.html), and [Pipes](http://r4ds.had.co.nz/pipes.html), DC Ecology Lesson on [Data Aggregation](http://www.datacarpentry.org/R-ecology-lesson/03-dplyr.html)  
...
```
`r datestring`  
__Readings:__ G&W Chapters on [Tidy Data](http://r4ds.had.co.nz/tidy-data.html), [Strings](http://r4ds.had.co.nz/strings.html), and [Factors](http://r4ds.had.co.nz/factors.html)  
...
```
`r datestring`  
__Readings:__ G&W Chapters on [Functions](http://r4ds.had.co.nz/functions.html) and [Iteration](http://r4ds.had.co.nz/iteration.html)  
...
```
`r datestring_1` and `r datestring`  
__Readings:__  G&W Chapter on [Relational Data](http://r4ds.had.co.nz/relational-data.html), Selected readings from DC [Geospatial Introduction](http://www.datacarpentry.org/R-spatial-raster-vector-lesson/)  
...
```
`r datestring_1` and `r datestring`  
__Readings:__  G&W on [Model Basics](http://r4ds.had.co.nz/model-basics.html) and [Model Building](http://r4ds.had.co.nz/model-building.html)  
