...
1. Using str_detect and filter select the massachusetts counties that contain the letter 
'h' in their county name.

2. Using str_detect and filter select the massachusetts counties that contain the number 
2 in their three digit county code.

3. Using str_sub, remove the word 'County' or 'city' and the trailing white space after the county name. 
