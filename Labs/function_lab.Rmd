...
```{r, eval = FALSE}
buoy_1987 <- read_csv('./buoydata/44013_1987.csv', na = c("99", "999"))
buoy_1988 <- read_csv('./buoydata/44013_1988.csv', na = c("99", "999"))
buoy_1989 <- read_csv('./buoydata/44013_1989.csv', na = c("99", "999"))
buoy_1990 <- read_csv('./buoydata/44013_1990.csv', na = c("99", "999"))
```

2b. Use the str_c() function to write the the filename for each year. I've given you an example below.
